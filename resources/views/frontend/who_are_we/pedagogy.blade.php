   ...
   <div class="container my-5">
       <div class="row">
           <div class="col-md-12">
               ...
               <p>The tools and techniques that CCT uses for ensuring effective pedagogy are:</p>

               <ol>
                   <li>ICT-based learning (conventional)</li>
                   <li>Internal Academic Audit system</li>
