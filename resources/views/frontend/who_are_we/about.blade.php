...
@section('content')
    <div class="container py-4">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <h1 class="text-uppercase">Our <span>Vision</span></h1>
                <p>
        ...
        <div class="row my-5">
            <div class="col-md-4 order-md-last">
                <img src="{{ asset('img/Class room Building B.jpg') }}" alt="" class="img-fluid">
            </div>
           <div class="col-md-8">
            <h1>Brief History of <span>CCT</span></h1>
            <p>
                After the implementation of national education in Nepal in 1971 (2028 B. S.), all the higher education centers scattered all over the country were unified under the umbrella of Tribhuvan University. Subsequently, Institute of Applied Science and Technology (IASTEC), which became the forerunner of Food Technology program in Nepal, was established in 1972 in Dharan. This was the turning point in the history of Food Technology education in Nepal.
            </p>
            
            <h5>Our Goals</h5>
            <ul>
                <li>Fully deploy the privileges of autonomy.</li>
                <li>Mobilize resources for developing infrastructure</li>
                <li>Prepare strategic plan for sustainability of all future programs</li>
                <li>Strengthen research facilities</li>
                <li>Run advanced academic programs in science and technology.</li>
            </ul>

            <h5>Early academic programs</h5>
            <p>The academic program included 4 relevant technologies:</p>
            <p>Laboratory technology</p>

            <ul>
                <li>Food technology</li>
                <li>Fat/oil and Soap Technology</li>
                <li>Environment Technology</li>
            </ul>

            <p>The program also included short term courses for following industries:</p>
            <ul>
                <li>Sugar</li>
                <li>Cigarette</li>
        ...
        <div class="row my-4">
            <div class="col-md-4">
                <img src="{{ asset('img/s1.jpg') }}" alt="" class="img-fluid">
            </div>
            <div class="col-md-8">
                <h5>Early institutional objectives</h5>
                <ul>
                    <li>Research and Innovation –for the utilization of local resources.</li>
                    <li>Documentation and Information – for documenting and compiling materials on science and technology, development/ establishment science and technology museum.</li>
                    <li>Instrumentation-  for development, repair/maintenance, enlisting of scientific equipment.</li>
                    <li>Academic program- for production of skilled manpower needed for value-adding agricultural produce.</li>
                </ul>

                <p>
                    Among the above proposed academic programs, however, only Food Technology and Laboratory Technology programs were run in this institute. These programs consisted of semester-based, two-year certificate level course (I-Tech.) in Food Technology and Laboratory Technology. The main objective of these courses was to produce middle-level technical manpower needed for the country. Because of the self-terminating nature of these programs, these were formally closed in 1977 after producing 79 and 87 graduates in Food Technology and Laboratory Technology, respectively
                </p>
            </div>
        </div>
        ...
        <div class="row my-4">
            <div class="col-md-4 order-md-last">
                <img src="{{ asset('img/Meat Pilot Plant.jpg') }}" alt="" class="img-fluid">
            </div>

            <div class="col-md-8">
                <h5>The making of the Institute of Science and Technology</h5>
                <p>
        ...
        <div class="row my-4">
            <div class="col-md-4">
                <img src="{{ asset('img/Wet Pilot Plant.jpg') }}" alt="" class="img-fluid">
            </div>

            <div class="col-md-8">
                <h5>The demise of the Institute</h5>
                <p>
                ...
                <p>
                    In 1977, certificate level programs to Food Technology and Laboratory Technology were formally terminated by the then Minister for Education, Mr. Pashupati Shamser Rana, thereby, apparently sealing the fate of food technology education. A certificate level program in pure science was then started in the campus instead of the technology programs.
                </p>
            </div>
        </div>
        ...
        <div class="row my-4">
            ...
            <div class="col-md-8">
               ...
               <p>
                Eventually, in 2001 Central Department of Food Technology was established for running M. Tech. and Ph.D. program in Food Technology whereupon Master Level in Food Technology was started in 2002. After the establishment of Central Department, it also started Ph.D. program.
               </p>
            </div>
        </div>
    </div>
